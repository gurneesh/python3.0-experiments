...
ffi_srcdir = '/home/smooth/Downloads/Python-3.0.1/Modules/_ctypes/libffi'
ffi_sources += ffi_platforms['X86_64']
ffi_sources = [os.path.join('/home/smooth/Downloads/Python-3.0.1/Modules/_ctypes/libffi', f) for f in ffi_sources]
