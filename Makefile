...
MODOBJS=          Modules/_threadmodule.o  Modules/signalmodule.o  Modules/posixmodule.o  Modules/errnomodule.o  Modules/pwdmodule.o  Modules/_sre.o  Modules/_codecsmodule.o  Modules/_fileio.o  Modules/_weakref.o  Modules/_bytesio.o  Modules/_stringio.o  Modules/zipimport.o  Modules/symtablemodule.o  Modules/xxsubtype.o
...
# Install everything
fullinstall:	 altinstall bininstall maninstall 
...
Python/thread.o:  $(srcdir)/Python/thread_atheos.h $(srcdir)/Python/thread_cthread.h $(srcdir)/Python/thread_foobar.h $(srcdir)/Python/thread_lwp.h $(srcdir)/Python/thread_nt.h $(srcdir)/Python/thread_os2.h $(srcdir)/Python/thread_pth.h $(srcdir)/Python/thread_pthread.h $(srcdir)/Python/thread_sgi.h $(srcdir)/Python/thread_solaris.h $(srcdir)/Python/thread_wince.h
...
Modules/_threadmodule.o: $(srcdir)/Modules/_threadmodule.c; $(CC) $(PY_CFLAGS)  -c $(srcdir)/Modules/_threadmodule.c -o Modules/_threadmodule.o
...
Modules/_fileio.o: $(srcdir)/Modules/_fileio.c; $(CC) $(PY_CFLAGS)  -c $(srcdir)/Modules/_fileio.c -o Modules/_fileio.o
Modules/_fileio$(SO):  Modules/_fileio.o; $(BLDSHARED)  Modules/_fileio.o   -o Modules/_fileio$(SO)
...
Modules/_bytesio.o: $(srcdir)/Modules/_bytesio.c; $(CC) $(PY_CFLAGS)  -c $(srcdir)/Modules/_bytesio.c -o Modules/_bytesio.o
Modules/_bytesio$(SO):  Modules/_bytesio.o; $(BLDSHARED)  Modules/_bytesio.o   -o Modules/_bytesio$(SO)
Modules/_stringio.o: $(srcdir)/Modules/_stringio.c; $(CC) $(PY_CFLAGS)  -c $(srcdir)/Modules/_stringio.c -o Modules/_stringio.o
Modules/_stringio$(SO):  Modules/_stringio.o; $(BLDSHARED)  Modules/_stringio.o   -o Modules/_stringio$(SO)
